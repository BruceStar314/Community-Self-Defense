...
const sidImage = { src: "/images/sid.png" };
const mylesImage = { src: "/images/myles.png" };
const domImage = { src: "/images/dom.png" };
const supportMissionImage = "/images/group.png";
const presidentImage = { src: "/images/President.webp" };
const treasurerImage = { src: "/images/Treasurer.webp" };
const secretaryImage = { src: "/images/Secretary.webp" };
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              <ImageWithFallback src={logo} alt="CSD Logo" width={48} height={48} />
              <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-2">
              {programs.map((program, index) => (
                <Link
                  ...
                  className={`block text-3xl md:text-4xl lg:text-5xl tracking-wider transition-all duration-300 py-2 ${
            ...
            <div className="relative h-[600px] rounded-lg overflow-hidden shadow-xl">
              <ImageWithFallback
                src={programs[hoveredProgram ?? 0].image}
                alt={programs[hoveredProgram ?? 0].name}
                className="w-full h-full object-cover transition-opacity duration-500"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
              <div className="absolute bottom-8 left-8 right-8">
                <h3 className="text-white text-3xl mb-2">{programs[hoveredProgram ?? 0].name}</h3>
                <Link
                  href={`/programs/${programs[hoveredProgram ?? 0].slug}`}
                  className="inline-flex bg-[hsl(217,63%,47%)] hover:bg-[hsl(217,63%,42%)] text-white px-6 py-2 rounded-lg transition-colors items-center gap-2"
                >
      ...
      <section id="trainers" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl mb-4 text-black">Meet Our Trainers</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {trainers.map((trainer, index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  <h3 className="text-2xl mb-2 text-black">{trainer.name}</h3>
      ...
      <section id="membership" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl mb-4 text-black">Membership Plans</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {membershipPlans.map((plan, index) => (
              <div 
                key={index} 
                className={`rounded-lg p-6 ${plan.popular ? 'bg-black text-white shadow-2xl scale-105 border-4 border-[hsl(217,63%,47%)]' : 'bg-gray-50 border-2 border-gray-200 text-black'}`}
              >
                {plan.popular && (
                ...
                <h3 className={`text-xl mb-3 ${plan.popular ? 'text-white' : 'text-black'}`}>{plan.name}</h3>
                <div className="mb-6">
                  <span className={`text-4xl ${plan.popular ? 'text-white' : 'text-black'}`}>{plan.price}</span>
                  <span className={`text-sm ${plan.popular ? 'text-gray-400' : 'text-gray-600'}`}>{plan.period}</span>
                </div>
      ...
      <section id="support" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl mb-6 text-black">Empowering The Community Through Self Defense</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl mb-3 text-black">Youth Programs</h3>
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              <div className="text-[hsl(217,63%,47%)] text-4xl mb-4">🏅</div>
              <h3 className="text-xl mb-3 text-black">Scholarships</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              <div className="text-[hsl(217,63%,47%)] text-4xl mb-4">👕</div>
              <h3 className="text-xl mb-3 text-black">Uniforms & Equipment</h3>
              <p className="text-gray-600">
...
>
  Make a Donation
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {classBody.map((classBody, index) => (
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  <h3 className="text-2xl mb-2 text-black">{classBody.name}</h3>
      ...
      <section id="contact" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl mb-4 text-black">Get In Touch</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
